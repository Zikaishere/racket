  ...
  return embed
    ...
    .addFields(
      { name: '1. Be respectful', value: 'No harassment, insults, slurs, or hostile behavior.', inline: false },
      {
        ...
        value: 'Use channels for their intended purpose and avoid derailing support conversations.',
        inline: false,
      },
      {
        name: '3. No spam',
        value: 'Do not flood channels, mass ping, self-promote, or post disruptive content.',
        inline: false,
      },
      {
        name: '4. Report issues clearly',
        value: 'When asking for help, include the command used, what happened, and what you expected instead.',
        inline: false,
      },
      {
        name: '5. No exploit abuse',
        value: 'Do not share or attempt malicious abuse, dupes, or bot-breaking behavior.',
        inline: false,
      },
      {
...
module.exports = {
  ...
  async execute({ message }) {
    ...
    return message.reply({
      embeds: [embed.success('Rules Posted', `I posted the rules embed in ${message.channel}.`)],
    });
  },
  ...
  async executeSlash({ interaction }) {
    ...
    return interaction.reply({
      embeds: [embed.success('Rules Posted', `I posted the rules embed in ${interaction.channel}.`)],
      ephemeral: true,
    });
  },
};
